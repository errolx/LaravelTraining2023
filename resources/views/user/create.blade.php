                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('role') is-invalid @enderror" id="role"
                                    name="role" type="text" placeholder="Role" value="{{ old('role') }}"
                                    required>
                                @error('role')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('dept') is-invalid @enderror" id="dept"
                                    name="dept" placeholder="Department" value="{{ old('dept') }}"
                                    required>
